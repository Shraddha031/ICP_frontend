...
const RescheduleInterview = () => {
  ...
  } = useFetch("http://intellisenseviz.herokuapp.com/user/");

  const {
    data: interviewerData,
    isPending: isInterviewerDataPending,
    error: interviewerDataError,
  } = useFetch("http://intellisenseviz.herokuapp.com/interviewer/");

  const {
    data: interviewData,
    isPending: isInterviewDataPending,
    error: interviewDataError,
  } = useFetch(`http://intellisenseviz.herokuapp.com/interviewer/${uuid}`);
